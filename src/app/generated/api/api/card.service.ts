...
export class CardService {
  ...
  /**
     ...
     * @param reportProgress flag to report request and response progress.
     */
  public getExhibitCardsByTeam(exhibitId: string, teamId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Card>>;
  public getExhibitCardsByTeam(exhibitId: string, teamId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Card>>>;
  public getExhibitCardsByTeam(exhibitId: string, teamId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Card>>>;
  public getExhibitCardsByTeam(exhibitId: string, teamId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    if (exhibitId === null || exhibitId === undefined) {
