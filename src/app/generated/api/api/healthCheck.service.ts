...
export class HealthCheckService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public healthGetLiveliness(observe?: 'body', reportProgress?: boolean): Observable<HealthReport>;
    public healthGetLiveliness(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HealthReport>>;
    public healthGetLiveliness(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HealthReport>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public healthGetReadiness(observe?: 'body', reportProgress?: boolean): Observable<HealthReport>;
    public healthGetReadiness(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<HealthReport>>;
    public healthGetReadiness(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<HealthReport>>;
