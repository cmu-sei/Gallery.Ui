...
export class ExhibitTeamService {
    ...
    /**
     * Gets ExhibitTeams for the specified exhibit
     * Returns a list of the specified exhibit&#39;s ExhibitTeams.
     * @param exhibitId
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
     public getExhibitTeamsByExhibit(exhibitId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<ExhibitTeam>>;
     public getExhibitTeamsByExhibit(exhibitId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ExhibitTeam>>>;
     public getExhibitTeamsByExhibit(exhibitId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ExhibitTeam>>>;
     public getExhibitTeamsByExhibit(exhibitId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
         if (exhibitId === null || exhibitId === undefined) {
