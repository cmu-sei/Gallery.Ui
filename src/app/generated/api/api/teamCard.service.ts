...
export class TeamCardService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCollectionTeamCards(collectionId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<TeamCard>>;
    public getCollectionTeamCards(collectionId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TeamCard>>>;
    public getCollectionTeamCards(collectionId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TeamCard>>>;
    public getCollectionTeamCards(collectionId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (collectionId === null || collectionId === undefined) {
            throw new Error('Required parameter collectionId was null or undefined when calling getCollectionTeamCards.');
        }
        ...
        return this.httpClient.get<Array<TeamCard>>(`${this.configuration.basePath}/api/collections/${encodeURIComponent(String(collectionId))}/teamcards`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
